...
public class ScenicListActivity extends KJActivity{
    ...
    private void refresh() {
    	...
    	//listview.setLoadMoreText("seeeeeeed");
    	//listview.setRefreshingText("lalalla");
    	//listview.setNormalText("小气鬼");
    ...
    class ListViewAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            name = scenics.get(position).getName();
