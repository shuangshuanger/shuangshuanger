...
public class GameListActivity extends KJActivity{
    ...
    public void initWidget() {
        ...
        listview.setOnItemClickListener(new OnItemClickListener()
        {
			...
			public void onItemClick(AdapterView<?> parent, View v, int position,
				...
				// TODO Auto-generated method stub
				Bundle bundle = new Bundle();
				String name = games.get(position-1).getName();
				String phoneNumber = games.get(position-1).getPhoneNum();
				String address = games.get(position-1).getAddress();
    ...
    class ListViewAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            name = games.get(position).getName();
